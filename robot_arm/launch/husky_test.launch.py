...
def generate_launch_description():
    ...
    # Prefer orchard_bolls.world (auto-generated by scripts/generate_bolls.py)
    # Falls back to orchard.world if bolls haven't been generated yet.
    ...
    # Delay controller spawner: when world has many entities (e.g. dynamic bolls),
    # Gazebo takes time to load them; controller_manager service may not respond
    # within the spawner's default timeout. Wait 8s after spawn_entity exits to
    # let Gazebo settle.
